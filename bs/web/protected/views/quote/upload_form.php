...
$(document).ready(function() {
	$("#uploadify").uploadify({
		...
		'script'         : '<?php echo URL_DOMAIN;?>/index.php?r=quote/uoption%26action=insert%26id=<?php echo $quote_id;?>',
		...
		'onAllComplete' : function(event,data) {
		      alert('上传成功！');
		      self.location='<?php echo URL_DOMAIN;?>/index.php?r=quote/ulist&id=<?php echo $quote_id;?>&referer=<?php echo urlencode($referer); ?>';
		    },
		'multi'          : true
	});
});
...
<br>
	<p>
      ...
      <a href="<?php echo URL_DOMAIN;?>/index.php?r=quote/ulist&id=<?php echo $quote_id;?>&referer=<?php echo urlencode($referer); ?>"  class='ui-state-default ui-corner-all'>返回</a>
    </p>
