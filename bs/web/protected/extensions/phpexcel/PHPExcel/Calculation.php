...
class PHPExcel_Calculation
{
    ...
    private static $_localeBoolean = array(
    ...
    private function _parseFormula ($formula, PHPExcel_Cell $pCell = null) {
        ...
        while (True) {
            ...
            elseif ($opCharacter == ',') { //	Is this the separator for function arguments?
                ...
                $d = $stack->last( 2 );
                if (!preg_match( '/^' . self::CALCULATION_REGEXP_FUNCTION . '$/i' , $d['value'] , $matches )) return $this->_raiseFormulaError( "Formula Error: Unexpected ," );
                $d = $stack->pop();
                ...
                switch ($token) {
                    ...
                    case ':': //	Range
                        ...
                        if ($sheet1 == $sheet2) {
                            ...
                            if (!is_null( $pCellParent )) {
                                $cellValue = $this->extractCellRange( $cellRef , $pCellParent->getParent()
        ...
        if (!is_null( $pSheet )) {
            ...
            if (count( $aReferences ) == 1) {
                ...
                if ($pSheet->cellExists( $aReferences[0] )) {
                    $returnValue[$currentRow][$currentCol] = $pSheet->getCell( $aReferences[0] )
                ...
                foreach ($aReferences as $reference) {
                    ...
                    if ($pSheet->cellExists( $reference )) {
                        $returnValue[$currentRow][$currentCol] = $pSheet->getCell( $reference )
                            ->getCalculatedValue( $resetLog );
                    }
                    else {
                        $returnValue[$currentRow][$currentCol] = NULL;
