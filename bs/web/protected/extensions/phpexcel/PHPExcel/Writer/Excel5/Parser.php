...
class PHPExcel_Writer_Excel5_Parser
{
    ...
    function _fact () {
        ...
        throw new Exception( "Syntax error: " . $this->_current_token . ", lookahead: " . $this->_lookahead . ", current char: " . $this->_current_char );
    }
        ...
        while ($this->_current_token != ')') {
            if ($num_args > 0) {
                if ($this->_current_token == "," or $this->_current_token == ";") {
                    ...
                    throw new Exception( "Syntax error: comma expected in " . "function $function, arg #{$num_args}" );
                }
