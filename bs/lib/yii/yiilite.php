...
abstract class CValidator extends CComponent {
    ...
    public static function createValidator ($name, $object, $attributes, $params) {
        if (is_string( $attributes )) $attributes = preg_split( 
                '/[\s,]+/' , 
                $attributes , 
                -1 , 
                PREG_SPLIT_NO_EMPTY );
        ...
        if (method_exists( $object , $name )) {
            ...
            if (isset( 
                    $params['skipOnError'] )) $validator->skipOnError = $params['skipOnError'];
        }
        else {
        ...
        $validator->on = empty( $on ) ? array() : array_combine( 
                $on , 
                $on );
        return $validator;
    }
    ...
    public function applyTo ($scenario) {
        return empty( $this->on ) || isset( 
                $this->on[$scenario] );
    }

    protected function addError ($object, $attribute, $message, $params = array()) {
        $params['{attribute}'] = $object->getAttributeLabel( 
                $attribute );
    ...
    protected function isEmpty ($value, $trim = false) {
        return $value === null || $value === array() || $value === '' || $trim && is_scalar( 
                $value ) && trim( 
                $value ) === '';
    }
}
class CStringValidator extends CValidator {
    ...
    protected function validateAttribute ($object, $attribute) {
        ...
        if ($this->allowEmpty && $this->isEmpty( 
                $value )) return;
        if ($this->encoding !== false && function_exists( 
                'mb_strlen' ))
            $length = mb_strlen( 
                    $value , 
                    $this->encoding );
        ...
        if ($this->min !== null && $length < $this->min) {
            $message = $this->tooShort !== null ? $this->tooShort : Yii::t( 
                    'yii' , 
        ...
        if ($this->max !== null && $length > $this->max) {
            $message = $this->tooLong !== null ? $this->tooLong : Yii::t( 
                    'yii' , 
...
class CNumberValidator extends CValidator {
    ...
    protected function validateAttribute ($object, $attribute) {
        ...
        if ($this->min !== null && $value < $this->min) {
            $message = $this->tooSmall !== null ? $this->tooSmall : Yii::t( 
                    'yii' , 
        ...
        if ($this->max !== null && $value > $this->max) {
            $message = $this->tooBig !== null ? $this->tooBig : Yii::t( 
                    'yii' , 
