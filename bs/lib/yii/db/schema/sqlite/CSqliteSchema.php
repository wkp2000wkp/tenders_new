 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CSqliteSchema.php 2262 2010-07-14 21:47:16Z qiang.xue $
...
class CSqliteSchema extends CDbSchema {
    ...
    protected function findColumns ($table) {
        ...
        if (is_string( $table->primaryKey ) && !strncasecmp( 
                $table->columns[$table->primaryKey]->dbType , 
                'int' , 
                3 )) $table->sequenceName = '';
        return true;
    }
