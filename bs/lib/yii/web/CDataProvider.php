...
abstract class CDataProvider extends CComponent implements IDataProvider {
    ...
    public function getPagination () {
        if ($this->_pagination === null) {
            ...
            if (($id = $this->getId()) != '') $this->_pagination->pageVar = $id . '_page';
        }
    ...
    public function getSort () {
        if ($this->_sort === null) {
            ...
            if (($id = $this->getId()) != '') $this->_sort->sortVar = $id . '_sort';
        }
        return $this->_sort;
    }
    ...
    public function getData ($refresh = false) {
        if ($this->_data === null || $refresh) $this->_data = $this->fetchData();
        return $this->_data;
    }
    ...
    public function getKeys ($refresh = false) {
        if ($this->_keys === null || $refresh) $this->_keys = $this->fetchKeys();
        return $this->_keys;
    }
    ...
    public function getTotalItemCount ($refresh = false) {
        if ($this->_totalItemCount === null || $refresh) $this->_totalItemCount = $this->calculateTotalItemCount();
