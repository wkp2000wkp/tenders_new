    ...
    public function registerClientScript () {
        ...
        if ($this->showRefreshButton) {
            $cs->registerScript( 
                    'Yii.CCaptcha#' . $id , 
                    'dummy' );
            $label = $this->buttonLabel === null ? Yii::t( 
                    'yii' , 
                    'Get a new code' ) : $this->buttonLabel;
            ...
            $html = CHtml::$button( 
                    ...
                    $this->buttonOptions );
            $js = "jQuery('img#$id').after(\"" . CJavaScript::quote( 
                    $html ) . '");';
            $cs->registerScript( 
                    'Yii.CCaptcha#' . $id , 
                    $js );
        ...
        if ($this->clickableImage) {
            $js = "jQuery('#$id').click(function(){" . CHtml::ajax( 
                    array(
