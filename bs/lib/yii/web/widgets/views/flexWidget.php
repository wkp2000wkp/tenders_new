...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
		"src", "<?php
echo $this->baseUrl?>/playerProductInstall",
...
echo $this->width?>"
		height="<?php
echo $this->height?>" name="<?php
echo $this->name?>"
		align="<?php
echo $this->align?>" play="true" loop="false"
		quality="<?php
echo $this->quality?>"
		allowScriptAccess="<?php
echo $this->allowScriptAccess?>"
