...
class ExportTongJiKaiBiaoRecordAction extends BaseTongJiListAction
{
...
// 		if($action!='duibi') $whereData['bid'] = BID_STR;
        ...
        if($action=='duibi'){
        	...
        	$fileName = "TJZBKBR".date("Y-m-d");
        	$phpExcelTool = new PHPExcelTool();
        	$phpExcelTool->exportPHPExcelToolTongJiKaiBiaoRecord2($data,$fileName);
        }
    }
