...
(function($){
  ...
  jQuery.fn.tableGear = function(options){
    ...
    function updateField(row, cell, input, span, column, key){
      ...
      $.post(url, params, function(response){
    	  var a = escape(response);
    	  var responseTmp = unescape(a.replace(/%uFEFF/,''));
    	  jobComplete(responseTmp, row, cell, input, span);
      });
