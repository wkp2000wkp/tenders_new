...
ALTER TABLE san_toubiao ADD `currency` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_zhaobiao ADD `currency` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_toubiao ADD `other_currency` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_zhaobiao ADD `other_currency` text NOT NULL  AFTER `skill_fee` ;
alter table san_zhaobiao drop column place_fee;
alter table san_toubiao drop column place_fee;
ALTER TABLE san_toubiao ADD `bid_fee_sort` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_zhaobiao ADD `bid_fee_sort` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_toubiao ADD `bid_fee_sort_other` text NOT NULL  AFTER `skill_fee` ;
ALTER TABLE san_zhaobiao ADD `bid_fee_sort_other` text NOT NULL  AFTER `skill_fee` ;
